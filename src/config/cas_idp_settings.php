...
$idp_host = env('SAML2_CAS_IDP_HOST', 'https://192.168.100.128:8443/cas');
...
return $settings = array(
    ...
    'sp' => array(
        ...
        'x509cert' => env('SAML2_CAS_SP_x509', ''),
        'privateKey' => env('SAML2_CAS_SP_PRIVATEKEY', ''),

        // Identifier (URI) of the SP entity.
        // Leave blank to use the '{idpName}_metadata' route, e.g. 'test_metadata'.
        'entityId' => env('SAML2_CAS_SP_ENTITYID', 'http://192.168.100.52:8000/saml2/cas/acs'),
